  ...
  return (
    <div className="relative h-[657px] bg-white">
      ...
      <img
        ...
        src="https://via.placeholder.com/228x221"
        alt="Placeholder"
      />
      ...
      <div className="absolute w-[319px] h-[53px] left-[53px] top-[499px] text-[#1a1a1a] text-[32px] font-normal font-['Patrick Hand']">
        0.26 shares of Apple stock
      </div>
